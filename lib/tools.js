...
export const tools = [
    ...
    },
    {
        ...
        inputSchema: {
            ...
            properties: {
                ...
                extraction_dir: {
                    type: "string",
                    description: "Directory where extracted JSON files will be written (manifest.json, metadata.json, turn_index.json, tracked_state.json)."
                }
            },
    ...
    },
    {
        ...
        description: "Retrieve previously extracted story data by category: manifest, metadata, turn_index, tracked_state, or turn_detail.",
        inputSchema: {
            type: "object",
            properties: {
                extraction_dir: {
