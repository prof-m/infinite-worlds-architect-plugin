...
export const tools = [
    ...
    },
    {
        ...
        description: "Updates the content of a specific section in a Markdown draft file. Requires an evidence citation documenting the source of the proposed value.",
        inputSchema: {
            type: "object",
            properties: {
                draftPath: { type: "string", description: "Absolute path to the draft_world.md file." },
                ...
                evidence: {
                    type: "string",
                    description: "Required. One of: (a) a story-data citation starting with 'From Turn #', 'From Story Metadata', 'From Turn Detail', or 'From Turn #N Tracked Item'; (b) 'USER_DIRECTED: <paraphrase of the user\\'s instruction>'; (c) 'CARRY_FORWARD: <reason>' for fields brought forward unchanged from the original world JSON; (d) 'NO_STORY_EVIDENCE: sampled turns [list], nothing relevant found' for gap cases where the field is left empty or marked as not described. Must be a non-empty string."
                }
            },
            required: ["draftPath", "sectionName", "newContent", "evidence"]
        }
    },
    {
        name: "validate_world",
