 ...
 * - If args.keywords is provided and non-empty: creates a Keyword Block (loreBookEntries)
 * - If args.keywords is omitted or empty: creates an Extra Instruction Block (instructionBlocks)
 *
 * @async
