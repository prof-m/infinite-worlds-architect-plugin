...
export const VALID_EFFECT_TYPES = [
    'scriptedText', 'effectTellAIWhatToDo', 'effectGiveInfo', 'changeAdventureBackground',
    ...
    'effectChangePCSkill', 'setTrackedItemsValue', 'randomTriggers', 'changeLorebook', 'endsGame'
];
